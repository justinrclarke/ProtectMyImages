...
use pmi::cli::Config;
use pmi::formats::{ImageFormat, detect_format, strip_metadata};
...
mod helpers {
    ...
    pub fn create_minimal_jpeg() -> Vec<u8> {
        vec![
            ...
            0x00, 0x01, 0x00, 0x00, // DQT.
            0xFF, 0xDB, 0x00, 0x43, 0x00, 0x08, 0x06, 0x06, 0x07, 0x06, 0x05, 0x08, 0x07, 0x07,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // SOS.
...
fn test_processor_dry_run() {
    ...
    assert!(
        has_exif,
        "Original file should still have EXIF in dry-run mode"
    );
